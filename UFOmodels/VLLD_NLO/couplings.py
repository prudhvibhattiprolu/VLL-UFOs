...
GC_16 = Coupling(name = 'GC_16',
                 value = 'complex(0,1)*gnupeRw',
                 order = {'VLL':1})

GC_17 = Coupling(name = 'GC_17',
                 value = 'complex(0,1)*gnupmRw',
                 order = {'VLL':1})

GC_18 = Coupling(name = 'GC_18',
                 value = 'complex(0,1)*gnuptRw',
                 order = {'VLL':1})

GC_19 = Coupling(name = 'GC_19',
                 value = 'complex(0,1)*gtaupeRz',
                 order = {'VLL':1})
...
GC_61 = Coupling(name = 'GC_61',
                 value = '-((complex(0,1)*gtaupeRh*MTAUP)/vev)',
                 order = {'QED':1,'VLL':1})

GC_62 = Coupling(name = 'GC_62',
                 value = '-((complex(0,1)*gtaupmuRh*MTAUP)/vev)',
                 order = {'QED':1,'VLL':1})

GC_63 = Coupling(name = 'GC_63',
                 value = '-((complex(0,1)*gtauptaRh*MTAUP)/vev)',
                 order = {'QED':1,'VLL':1})
