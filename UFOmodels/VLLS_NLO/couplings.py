...
GC_16 = Coupling(name = 'GC_16',
                 value = 'complex(0,1)*gtaupeLz',
                 order = {'VLL':1})

GC_17 = Coupling(name = 'GC_17',
                 value = 'complex(0,1)*gtaupmuLz',
                 order = {'VLL':1})

GC_18 = Coupling(name = 'GC_18',
                 value = 'complex(0,1)*gtauptaLz',
                 order = {'VLL':1})

GC_19 = Coupling(name = 'GC_19',
                 value = 'complex(0,1)*gtaupveLw',
                 order = {'VLL':1})
...
GC_20 = Coupling(name = 'GC_20',
                 value = 'complex(0,1)*gtaupvmLw',
                 order = {'VLL':1})

GC_21 = Coupling(name = 'GC_21',
                 value = 'complex(0,1)*gtaupvtLw',
                 order = {'VLL':1})
...
GC_56 = Coupling(name = 'GC_56',
                 value = '-(cw*complex(0,1)*gtaupnupw3) - complex(0,1)*gnupb*sw',
                 order = {'VLL':1})
...
GC_58 = Coupling(name = 'GC_58',
                 value = 'cw*complex(0,1)*gnupb - complex(0,1)*gtaupnupw3*sw',
                 order = {'VLL':1})
...
GC_62 = Coupling(name = 'GC_62',
                 value = '-((complex(0,1)*gtaupeLh*MTAUP)/vev)',
                 order = {'QED':1})

GC_63 = Coupling(name = 'GC_63',
                 value = '-((complex(0,1)*gtaupmuLh*MTAUP)/vev)',
                 order = {'QED':1})

GC_64 = Coupling(name = 'GC_64',
                 value = '-((complex(0,1)*gtauptaLh*MTAUP)/vev)',
                 order = {'QED':1})
